...
import {View, Image, Dimensions, ImageBackground, Text, Linking, Clipboard , ToastAndroid, Share,StatusBar, ActivityIndicator, Modal, TouchableWithoutFeedback, TouchableOpacity} from 'react-native';
...
export default function LastCoupons ({navigation, route}){
...
<Header style={{
  ...
  <Coupons copy={copy} onShare={onShare} navigation={navigation} addToFavourit={addToFavourit}/>
